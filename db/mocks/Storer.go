...
// GetBookings provides a mock function with given fields: ctx, email
func (_m *Storer) GetBookings(ctx context.Context, email string) ([]db.Booking, error) {
...
// GetSeatsByIDandShowID provides a mock function with given fields: ctx, seat_id, show_id
func (_m *Storer) GetSeatsByIDandShowID(ctx context.Context, seat_id []int, show_id int) (int, error) {
	ret := _m.Called(ctx, seat_id, show_id)

	var r0 int
	if rf, ok := ret.Get(0).(func(context.Context, []int, int) int); ok {
		r0 = rf(ctx, seat_id, show_id)
	} else {
		r0 = ret.Get(0).(int)
	}
